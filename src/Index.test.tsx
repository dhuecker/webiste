...
describe('application tests', () => {
  ...
  it('should render name: David Huecker', () => {
    const element = screen.getByTestId('name');

    checkContent(element, /^David Huecker$/);
  });
  ...
  it('should render creator', () => {
    ...
    checkContent(element, /^David Huecker$/, 'https://www.adamalston.com');
  });
  ...
  it('should render GitHub button', () => {
    ...
    checkButton(parent, child, /^GitHub$/, 'https://github.com/dhuecker');
  });
...
describe('app context tests', () => {
  it('should render partial footer on mobile', () => {
    ...
    expect(footer).toHaveTextContent(/^Designed and built by David Huecker$/);
